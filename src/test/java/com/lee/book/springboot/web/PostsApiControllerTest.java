...
public class PostsApiControllerTest {
    ...
    public void Posts_수정된다() throws Exception {
        ...
        //then
        assertThat(responseEntity.getStatusCode()).isEqualTo(HttpStatus.OK); // 요청이 정상적으로 동작했는지 검증
        assertThat(responseEntity.getBody()).isGreaterThan(0L); // 결과 값이 존재하는지 검증
        // (정상적으로 Posts를 업데이트 했을 때 Entity의 Long타입으로 선언된 id값을 결과로 반환하기 때문에)
